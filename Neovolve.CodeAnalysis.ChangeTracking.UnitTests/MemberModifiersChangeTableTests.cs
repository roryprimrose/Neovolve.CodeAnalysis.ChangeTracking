namespace Neovolve.CodeAnalysis.ChangeTracking.UnitTests
{
    ...
    public class MemberModifiersChangeTableTests
    {
        ...
        {
            var oldMember = new TestPropertyDefinition().Set(x => x.Modifiers = oldModifiers);
            var newMember = new TestPropertyDefinition().Set(x => x.Modifiers = newModifiers);
            var match = new ItemMatch<IPropertyDefinition>(oldMember, newMember);

            var actual = MemberModifiersChangeTable.CalculateChange(match);
