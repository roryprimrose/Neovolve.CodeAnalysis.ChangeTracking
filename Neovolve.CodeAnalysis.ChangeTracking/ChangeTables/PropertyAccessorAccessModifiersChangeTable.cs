namespace Neovolve.CodeAnalysis.ChangeTracking.ChangeTables
{
    ...
    public class PropertyAccessorAccessModifiersChangeTable : ChangeTable<PropertyAccessorAccessModifiers>, IPropertyAccessorAccessModifiersChangeTable
    {
        protected override void BuildChanges()
        {
            ...
            AddChange(PropertyAccessorAccessModifiers.None, PropertyAccessorAccessModifiers.None, SemVerChangeType.None );
            ...
            AddChange(PropertyAccessorAccessModifiers.Internal, PropertyAccessorAccessModifiers.Internal, SemVerChangeType.None );
            ...
            AddChange(PropertyAccessorAccessModifiers.Private, PropertyAccessorAccessModifiers.Private, SemVerChangeType.None );
            ...
            AddChange(PropertyAccessorAccessModifiers.Protected, PropertyAccessorAccessModifiers.Protected, SemVerChangeType.None );
            ...
            AddChange(PropertyAccessorAccessModifiers.ProtectedInternal, PropertyAccessorAccessModifiers.ProtectedInternal, SemVerChangeType.None );
