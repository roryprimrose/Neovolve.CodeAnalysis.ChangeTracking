namespace Neovolve.CodeAnalysis.ChangeTracking.ChangeTables
{
    ...
    public class MemberModifiersChangeTable : ChangeTable<MemberModifiers>, IMemberModifiersChangeTable
    {
        protected override void BuildChanges()
        {
            ...
            AddChange(MemberModifiers.None, MemberModifiers.None, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.None, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.None, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.None, MemberModifiers.Override, SemVerChangeType.Feature);
            AddChange(MemberModifiers.None, MemberModifiers.Sealed, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.None, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.None, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Abstract, MemberModifiers.Override, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Abstract, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Abstract, MemberModifiers.AbstractOverride, SemVerChangeType.None);
            AddChange(MemberModifiers.Abstract, MemberModifiers.NewAbstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Abstract, MemberModifiers.NewAbstractVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Abstract, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Abstract, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Abstract, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.None, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.Override, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.Sealed, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.Static, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.New, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.New, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Override, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Override, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Override, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.None, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.Override, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.Sealed, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.Static, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Sealed, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.Sealed, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Static, MemberModifiers.Static, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Static, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Virtual, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.Virtual, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.Override, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.AbstractOverride, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.NewAbstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.NewAbstractVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.AbstractOverride, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.Override, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.AbstractOverride, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.NewAbstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.NewAbstractVirtual, SemVerChangeType.Feature);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstract, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.Override, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.AbstractOverride, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.NewAbstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.NewAbstractVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewAbstractVirtual, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewStatic, MemberModifiers.Static, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewStatic, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewVirtual, MemberModifiers.Override, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewVirtual, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.NewVirtual, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.NewVirtual, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.None, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.New, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.Override, SemVerChangeType.Feature);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.Sealed, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.Static, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.Virtual, SemVerChangeType.Breaking);
            ...
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.NewVirtual, SemVerChangeType.Breaking);
            AddChange(MemberModifiers.SealedOverride, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
