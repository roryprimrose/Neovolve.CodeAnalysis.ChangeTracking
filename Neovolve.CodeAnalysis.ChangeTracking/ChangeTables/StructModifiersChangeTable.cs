namespace Neovolve.CodeAnalysis.ChangeTracking.ChangeTables
{
    ...
    public class StructModifiersChangeTable : ChangeTable<StructModifiers>, IStructModifiersChangeTable
    {
        protected override void BuildChanges()
        {
            ...
            AddChange(StructModifiers.None, StructModifiers.None, SemVerChangeType.None);
            ...
            AddChange(StructModifiers.ReadOnly, StructModifiers.ReadOnly, SemVerChangeType.None);
            ...
            AddChange(StructModifiers.Partial, StructModifiers.Partial, SemVerChangeType.None);
            ...
            AddChange(StructModifiers.ReadOnlyPartial, StructModifiers.ReadOnlyPartial, SemVerChangeType.None);
