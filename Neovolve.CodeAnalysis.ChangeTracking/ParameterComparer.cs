namespace Neovolve.CodeAnalysis.ChangeTracking
{
    ...
    {
        public ParameterComparer(IAttributeMatchProcessor attributeProcessor) : base(attributeProcessor)
        {
        }
        ...
        private static void EvaluateModifierChanges(
            ...
            IChangeResultAggregator aggregator)
        {
            var change = ParameterModifierChangeTable.CalculateChange(match);
