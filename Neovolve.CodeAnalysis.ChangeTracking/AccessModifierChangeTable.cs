namespace Neovolve.CodeAnalysis.ChangeTracking
{
    ...
    public static class AccessModifierChangeTable
    {
            ...
            BuildModifierChanges()
        {
            ...
            AddModifierChange(changes, AccessModifier.None, AccessModifier.Protected, SemVerChangeType.Feature );
            AddModifierChange(changes, AccessModifier.None, AccessModifier.Public, SemVerChangeType.Feature );
            AddModifierChange(changes, AccessModifier.None, AccessModifier.ProtectedInternal, SemVerChangeType.Feature );
            AddModifierChange(changes, AccessModifier.None, AccessModifier.ProtectedPrivate, SemVerChangeType.Feature );
            AddModifierChange(changes, AccessModifier.Internal, AccessModifier.None, SemVerChangeType.None );
            ...
            AddModifierChange(changes, AccessModifier.Private, AccessModifier.None, SemVerChangeType.None );
            ...
            AddModifierChange(changes, AccessModifier.Protected, AccessModifier.None, SemVerChangeType.Breaking );
            ...
            AddModifierChange(changes, AccessModifier.ProtectedInternal, AccessModifier.None, SemVerChangeType.Breaking );
