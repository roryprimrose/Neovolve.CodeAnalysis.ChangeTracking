namespace Neovolve.CodeAnalysis.ChangeTracking
{
    ...
    {
        public static Task<SemVerChangeType> CalculateChange(this IChangeCalculator calculator,
        ...
        public static async Task<SemVerChangeType> CalculateChange(this IChangeCalculator calculator,
            IEnumerable<string> oldCode,
            IEnumerable<string> newCode, CancellationToken cancellationToken)
        {
            ...
            return calculator.CalculateChange(oldNodes, newNodes);
        }
