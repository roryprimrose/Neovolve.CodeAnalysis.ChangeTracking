namespace Neovolve.CodeAnalysis.ChangeTracking
{
    ...
    public static class MemberModifiersChangeTable
    {
            ...
            BuildModifierChanges()
        {
            ...
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.None, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.New, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.Override, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.Sealed, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.None, MemberModifiers.SealedOverride, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.None, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.Abstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.New, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.Override, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.Virtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.AbstractOverride, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.NewAbstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.NewAbstractVirtual, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.Abstract, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.None, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.New, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.Override, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.Sealed, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.Static, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.Virtual, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.New, MemberModifiers.SealedOverride, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Override, MemberModifiers.Override, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Override, MemberModifiers.Virtual, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Override, MemberModifiers.NewVirtual, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Override, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.None, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.New, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.Override, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.Sealed, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.Static, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.Virtual, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.Sealed, MemberModifiers.SealedOverride, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Static, MemberModifiers.Static, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Static, MemberModifiers.NewStatic, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Virtual, MemberModifiers.Virtual, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.Virtual, MemberModifiers.NewVirtual, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.Abstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.New, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.Override, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.Virtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.AbstractOverride, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.NewAbstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.NewAbstractVirtual, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.AbstractOverride, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.Abstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.New, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.Override, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.Virtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.AbstractOverride, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.NewAbstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.NewAbstractVirtual, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.NewAbstract, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.Abstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.New, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.Override, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.Virtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.AbstractOverride, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.NewAbstract, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.NewAbstractVirtual, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.NewStatic, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.NewAbstractVirtual, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.NewStatic, MemberModifiers.Static, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.NewStatic, MemberModifiers.NewStatic, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.NewVirtual, MemberModifiers.Override, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.NewVirtual, MemberModifiers.Virtual, SemVerChangeType.None);
            ...
            AddModifierChange(changes, MemberModifiers.NewVirtual, MemberModifiers.NewVirtual, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.NewVirtual, MemberModifiers.SealedOverride, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.None, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.Abstract, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.New, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.Override, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.Sealed, SemVerChangeType.None);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.Static, SemVerChangeType.Breaking);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.Virtual, SemVerChangeType.Feature);
            ...
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.NewVirtual, SemVerChangeType.Feature);
            AddModifierChange(changes, MemberModifiers.SealedOverride, MemberModifiers.SealedOverride, SemVerChangeType.None);
